...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        while (window.pollEvent(event))
        {
            ...
            if (event.type == sf::Event::KeyPressed)
            {
                ...
                case sf::Keyboard::Left:
                    x -= 2.0f; // Déplacer le sprite vers la gauche
                ...
                case sf::Keyboard::Right:
                    x += 2.0f; // Déplacer le sprite vers la droite
                    sprite2.setTexture(texturePlane2Base);
                    if (plane4) sprite4.setTexture(texturePlane4Base);
                    break;

                case sf::Keyboard::Up:
                    y -= 2.0f; // Déplacer le sprite vers le haut
                ...
                case sf::Keyboard::Down:
                    y += 2.0f; // Déplacer le sprite vers le bas
        ...
        if (plane1 || plane2 || defaultOne && !plane4)
        {
            ...
            window.draw(cloudss);
            sf::Vector2f cloudPositiona = cloudss.getPosition(); //Recup la position de la pokéball
            if (cloudPositiona.x < -1280) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680) + 20; //prend une hauteur aléatoire
                cloudss.setPosition(sf::Vector2f(1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss2);
            sf::Vector2f cloudPosition2a = cloudss2.getPosition(); //Recup la position de la pokéball
            if (cloudPosition2a.x < -1480) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680) + 20; //prend une hauteur aléatoire
                cloudss2.setPosition(sf::Vector2f(1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss3);
            sf::Vector2f cloudPosition3a = cloudss3.getPosition(); //Recup la position de la pokéball
            if (cloudPosition3a.x < -1760) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680) + 20; //prend une hauteur aléatoire
                cloudss3.setPosition(sf::Vector2f(1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss4);
            sf::Vector2f cloudPosition4a = cloudss4.getPosition(); //Recup la position de la pokéball
            if (cloudPosition4a.x < -1760) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680) + 20; //prend une hauteur aléatoire
                cloudss4.setPosition(sf::Vector2f(1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss6);
            sf::Vector2f cloudPosition6a = cloudss6.getPosition(); //Recup la position de la pokéball
            if (cloudPosition6a.x < -2760) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680) + 20; //prend une hauteur aléatoire
                cloudss6.setPosition(sf::Vector2f(1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss7);
            sf::Vector2f cloudPosition7a = cloudss7.getPosition(); //Recup la position de la pokéball
            if (cloudPosition7a.x < -1760) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680) + 20; //prend une hauteur aléatoire
                cloudss7.setPosition(sf::Vector2f(1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss8);
            sf::Vector2f cloudPosition8a = cloudss8.getPosition(); //Recup la position de la pokéball
            if (cloudPosition8a.x < -3000) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680) + 20; //prend une hauteur aléatoire
                cloudss8.setPosition(sf::Vector2f(1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss9);
            sf::Vector2f cloudPosition9a = cloudss9.getPosition(); //Recup la position de la pokéball
            if (cloudPosition9a.x < -3000) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680) + 20; //prend une hauteur aléatoire
                cloudss9.setPosition(sf::Vector2f(1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss10);
            sf::Vector2f cloudPosition10a = cloudss9.getPosition(); //Recup la position de la pokéball
            if (cloudPosition10a.x < -3000) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 70) + 20; //prend une hauteur aléatoire
                cloudss10.setPosition(sf::Vector2f(1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
        ...
        if (plane3 && !plane4)
        {
            window.draw(cloudss);
            sf::Vector2f cloudPosition = cloudss.getPosition(); //Recup la position de la pokéball
            if (cloudPosition.x > 2280) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680) + 20; //prend une hauteur aléatoire
                cloudss.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss2);
            sf::Vector2f cloudPosition2 = cloudss2.getPosition(); //Recup la position de la pokéball
            if (cloudPosition2.x > 2480) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680) + 20; //prend une hauteur aléatoire
                cloudss2.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss7);
            sf::Vector2f cloudPosition7 = cloudss7.getPosition(); //Recup la position de la pokéball
            if (cloudPosition7.x > 2760) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680) + 20; //prend une hauteur aléatoire
                cloudss7.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            if (cloudPositiona.x > 1280) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 20) + 20; //prend une hauteur aléatoire
                cloudss.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            if (cloudPosition7a.x > 1760) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 20) + 2; //prend une hauteur aléatoire
                cloudss7.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss);
            sf::Vector2f cloudPositionz = cloudss.getPosition(); //Recup la position de la pokéball
            if (cloudPositionz.x > 2280) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 360); //prend une hauteur aléatoire
                cloudss.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            cloudss.move(13.9, 0); //Bouge vers la gauche

            window.draw(cloudss2);
            sf::Vector2f cloudPosition2z = cloudss2.getPosition(); //Recup la position de la pokéball
            if (cloudPosition2z.x > 2480) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 360); //prend une hauteur aléatoire
                cloudss2.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss3);
            sf::Vector2f cloudPosition3z = cloudss3.getPosition(); //Recup la position de la pokéball
            if (cloudPosition3z.x > 1760) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 360); //prend une hauteur aléatoire
                cloudss3.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss4);
            sf::Vector2f cloudPosition4z = cloudss4.getPosition(); //Recup la position de la pokéball
            if (cloudPosition4z.x > 1760) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 360); //prend une hauteur aléatoire
                cloudss4.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss6);
            sf::Vector2f cloudPosition6z = cloudss6.getPosition(); //Recup la position de la pokéball
            if (cloudPosition6z.x > 1760) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 360); //prend une hauteur aléatoire
                cloudss6.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss7);
            sf::Vector2f cloudPosition7z = cloudss7.getPosition(); //Recup la position de la pokéball
            if (cloudPosition7z.x > 2760) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 360); //prend une hauteur aléatoire
                cloudss7.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss8);
            sf::Vector2f cloudPosition8z = cloudss8.getPosition(); //Recup la position de la pokéball
            if (cloudPosition8z.x > 3000) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 360); //prend une hauteur aléatoire
                cloudss8.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss9);
            sf::Vector2f cloudPosition9z = cloudss9.getPosition(); //Recup la position de la pokéball
            if (cloudPosition9z.x > 3000) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 360); //prend une hauteur aléatoire
                cloudss9.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            ...
            window.draw(cloudss10);
            sf::Vector2f cloudPosition10z = cloudss9.getPosition(); //Recup la position de la pokéball
            if (cloudPosition10z.x > 3000) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 20); //prend une hauteur aléatoire
                cloudss10.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            cloudss10.move(11.1, 0); //Bouge vers la gauche
            ...
            sf::Vector2f cloudPositionaz = cloudsso.getPosition(); //Recup la position de la pokéball
            if (cloudPositionaz.x > 1280) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 20); //prend une hauteur aléatoire
                cloudsso.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            cloudsso.move(11.9, 0); //Bouge vers la gauche

            window.draw(cloudss2o);
            sf::Vector2f cloudPosition2az = cloudss2o.getPosition(); //Recup la position de la pokéball
            if (cloudPosition2az.x > 1480) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 360); //prend une hauteur aléatoire
                cloudss2o.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            cloudss2o.move(1.2, 0); //Bouge vers la gauche

            window.draw(cloudss3o);
            sf::Vector2f cloudPosition3az = cloudss3o.getPosition(); //Recup la position de la pokéball
            if (cloudPosition3az.x > 1760) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 10); //prend une hauteur aléatoire
                cloudss3o.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            cloudss3o.move(.2, 0); //Bouge vers la gauche

            window.draw(cloudss4o);
            sf::Vector2f cloudPosition4az = cloudss4o.getPosition(); //Recup la position de la pokéball
            if (cloudPosition4az.x > 1760) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 10); //prend une hauteur aléatoire
                cloudss4o.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            cloudss4o.move(1.2, 0); //Bouge vers la gauche

            window.draw(cloudss6o);
            sf::Vector2f cloudPosition6az = cloudss6o.getPosition(); //Recup la position de la pokéball
            if (cloudPosition6az.x > 2760) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 10); //prend une hauteur aléatoire
                cloudss6o.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            cloudss6o.move(.2, -2); //Bouge vers la gauche

            window.draw(cloudss7o);
            sf::Vector2f cloudPosition7az = cloudss7o.getPosition(); //Recup la position de la pokéball
            if (cloudPosition7az.x > 1760) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 10); //prend une hauteur aléatoire
                cloudss7o.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            cloudss7o.move(2.7, -.5); //Bouge vers la gauche

            window.draw(cloudss8o);
            sf::Vector2f cloudPosition8az = cloudss8o.getPosition(); //Recup la position de la pokéball
            if (cloudPosition8az.x > 3000) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 10); //prend une hauteur aléatoire
                cloudss8o.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            cloudss8o.move(.2, -.4); //Bouge vers la gauche

            window.draw(cloudss9o);
            sf::Vector2f cloudPosition9az = cloudss9o.getPosition(); //Recup la position de la pokéball
            if (cloudPosition9az.x > 3000) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 10); //prend une hauteur aléatoire
                cloudss9o.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            cloudss9o.move(.2, -.4); //Bouge vers la gauche

            window.draw(cloudss10o);
            sf::Vector2f cloudPosition10az = cloudss10o.getPosition(); //Recup la position de la pokéball
            if (cloudPosition10az.x > 3000) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 360); //prend une hauteur aléatoire
                cloudss10o.setPosition(sf::Vector2f(-1000, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
        ...
        window.draw(sprite4);
        sf::Vector2f spritPosition4 = sprite4.getPosition(); //Recup la position de la pokéball
        if (spritPosition4.x < -380 || spritPosition4.y < -135 || spritPosition4.y > 950 || spritPosition4.x > 1600) //si c'est à gauche de l'écran en hors champs
        {
            int y = (150, 150); //prend une hauteur aléatoire
            sprite4.setPosition(150, 150); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
        }
        ...
        if (plane4 && !plane2)
        {
            ...
            sf::Vector2f ParticulePosition = Particulee.getPosition(); //Recup la position de la pokéball
            if (ParticulePosition.x > 2500) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680); //prend une hauteur aléatoire
                Particulee.setPosition(sf::Vector2f(-200, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            Particulee.move(180.9, 0); //Bouge vers la gauche

            window.draw(Particulee2);
            sf::Vector2f ParticulePosition2 = Particulee2.getPosition(); //Recup la position de la pokéball
            if (ParticulePosition2.x > 2500) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680); //prend une hauteur aléatoire
                Particulee2.setPosition(sf::Vector2f(-200, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            Particulee2.move(170.9, 0); //Bouge vers la gauche

            window.draw(Particulee3);
            sf::Vector2f ParticulePosition3 = Particulee3.getPosition(); //Recup la position de la pokéball
            if (ParticulePosition3.x > 2500) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680); //prend une hauteur aléatoire
                Particulee3.setPosition(sf::Vector2f(-200, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            Particulee3.move(240, 0); //Bouge vers la gauche

            window.draw(Particulee4);
            sf::Vector2f ParticulePosition4 = Particulee4.getPosition(); //Recup la position de la pokéball
            if (ParticulePosition4.x > 2500) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680); //prend une hauteur aléatoire
                Particulee4.setPosition(sf::Vector2f(-200, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            Particulee4.move(260.9, 0); //Bouge vers la gauche

            window.draw(Particulee5);
            sf::Vector2f ParticulePosition5 = Particulee5.getPosition(); //Recup la position de la pokéball
            if (ParticulePosition5.x > 2500) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680); //prend une hauteur aléatoire
                Particulee5.setPosition(sf::Vector2f(-200, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
            Particulee5.move(220, 0); //Bouge vers la gauche

            window.draw(Particulee6);
            sf::Vector2f ParticulePosition6 = Particulee6.getPosition(); //Recup la position de la pokéball
            if (ParticulePosition6.x > 2500) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680); //prend une hauteur aléatoire
                Particulee6.setPosition(sf::Vector2f(-200, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
            }
        ...
        if (plane4 && isPlaying)
        {
            ...
            sf::Vector2f RayonLaserPosition = RayonLaserr.getPosition(); //Recup la position de la pokéball
            if (RayonLaserPosition.x < -280) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680) + 24; //prend une hauteur aléatoire
                RayonLaserr.setPosition(sf::Vector2f(1600, y)); //Remet la pokéball à droite hors champs 

            }
            RayonLaserr.move(-20.4, 0); //Bouge vers la gauche

            window.draw(RayonLaserr2);
            sf::Vector2f RayonLaserPosition2 = RayonLaserr2.getPosition(); //Recup la position de la pokéball
            if (RayonLaserPosition2.x < -280) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680) + 24; //prend une hauteur aléatoire
                RayonLaserr2.setPosition(sf::Vector2f(1600, y)); //Remet la pokéball à droite hors champs 

            }
            RayonLaserr2.move(-14.8, 0); //Bouge vers la gauche

            window.draw(RayonLaserr3);
            sf::Vector2f RayonLaserPosition3 = RayonLaserr3.getPosition(); //Recup la position de la pokéball
            if (RayonLaserPosition3.x < -280) //si c'est à gauche de l'écran en hors champs
            {
                int y = (rand() % 680) + 24; //prend une hauteur aléatoire
                RayonLaserr3.setPosition(sf::Vector2f(1600, y)); //Remet la pokéball à droite hors champs 
...
//        {
//            int y = (rand() % 680) + 24; //prend une hauteur aléatoire
//            Missileee1.setPosition(sf::Vector2f(1600, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
//        }
...
//        {
//            int y = (rand() % 680) + 200; //prend une hauteur aléatoire
//            Missileee2.setPosition(sf::Vector2f(1600, y)); //Remet la pokéball à droite hors champs à la hauteur piochée au dessus
//        }
